...
public class RegularBusTest {
  ...
  public void testConstructorNormal(){
    ...
    double speed = 0.0;
    RegularBus regularBus = new RegularBus(name, testRouteOut, testRouteIn, speed);
    assertEquals("test", regularBus.getName());
    assertEquals(0.0, regularBus.getSpeed());
    assertEquals(60, regularBus.getCapacity());
  }
}
