...
public class LargeBusTest {
  ...
  public void testConstructorNormal() {
    ...
    double speed = 0.0;
    LargeBus largeBus = new LargeBus(name, testRouteOut, testRouteIn, speed);
    assertEquals("test", largeBus.getName());
    assertEquals(0.0, largeBus.getSpeed());
    assertEquals(90, largeBus.getCapacity());
  }
}
